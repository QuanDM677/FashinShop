...
import fashion.store.ui.manager.controller.CategoryController;
...
public class CategoryManagerJDialog extends javax.swing.JDialog implements CategoryController {
    ...
    private String generateCategoryId() {
        ...
        for (Category category : categories) {
            String id = category.getId().replace("CAT", ""); // Loại bỏ tiền tố "LSP"
            try {
        ...
        return String.format("CAT%03d", maxId + 1); // Tạo mã mới, ví dụ: LSP001
    }
