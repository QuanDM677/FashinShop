...
public class Bill {
    ...
    private int status;
    private String customerId; // <-- Thêm dòng này
    ...
    public Bill(Long id, String username, Date checkin, Date checkout, int status, String customerId) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (customerId != null ? !customerId.equals(bill.customerId) : bill.customerId != null) {
            return false;
        }
