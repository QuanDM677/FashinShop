...
import fashion.store.dao.impl.UserDAOImpl;
...
public class BillManagerJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        rdoDangXuLy = new javax.swing.JRadioButton();
        ...
        tblBills.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã phiếu", "Mã khách hàng", "Thời điểm tạo", "Thời điểm thanh toán", "Trạng thái", "Người tạo", "Chọn"
            }
        ) {
        ...
        buttonGroup1.add(rdoDangXuLy);
        rdoDangXuLy.setSelected(true);
        rdoDangXuLy.setText("Đang xử lý");
...
// Kiểm tra người tạo có tồn tại
    ...
    private boolean validateForm() {
        // Thẻ số
        String cardIdStr = txtMaKhachHang.getText().trim();
        ...
        // Trạng thái
        if (!rdoDangXuLy.isSelected() && !rdoHoanThanh.isSelected() && !rdoDaHuy.isSelected()) {
    ...
    public Bill getForm() {
        ...
        bill.setCustomerId(!txtMaKhachHang.getText().isBlank() ? String.valueOf(txtMaKhachHang.getText()) : null);
    ...
    public void setForm(Bill entity) {
        ...
        txtMaKhachHang.setText(entity.getCustomerId() == null ? "" : entity.getCustomerId().toString());
        ...
        rdoDangXuLy.setSelected(entity.getStatus() == 0);
    ...
    private javax.swing.JRadioButton rdoDangXuLy;
